...
4. Prefix + Rang-Anzeige + Clan-Tag in Chat/Tab testen
5. Drop->Command Inventory-Regression reproduzieren und verifizieren
6. Crate/Voucher Rapid-Click-, Restart- und Inventar-Move-Dupeversuche ingame testen
7. PlayerShop Kauf vs. Stock-Withdraw, Revenue-Doppelclaim und Restart-Fenster testen
8. Trade-Offer waehrend Countdown aendern, Quit/Close und Coin-Aenderungen testen
9. Duel/Wager und LMS im echten Multiplayer testen
10. Clan Wars als 2v2, 3v3 und 5v5 inklusive Quit/Forfeit testen
11. Mob-Stacking mit grossen Spawner-Farmen auf Performance, Drops und Restart-Verhalten testen
12. Discord-Relay optional mit echtem Bot/Channel testen
13. Backup -> Daten veraendern -> Restore -> Persistenz vergleichen
14. Economy-/Reward-Balance unter realistischen Spielerzahlen testen
15. danach Soft-Launch-Gate statt weitere Kernsysteme blind aufzubauen
