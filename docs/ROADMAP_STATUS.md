...
6. Tournament mit 4/5/8 Spielern testen
7. Juggernaut mit 3+ Spielern, Boss-Quit und Team-Damage testen
8. Clan Wars als 2v2, 3v3 und 5v5 inklusive Quit/Forfeit testen
9. Backup -> Daten veraendern -> Restore -> Persistenz vergleichen
10. Economy-/Reward-Balance unter realistischen Spielerzahlen testen
11. danach Soft-Launch-Gate statt weitere Kernsysteme blind aufzubauen
