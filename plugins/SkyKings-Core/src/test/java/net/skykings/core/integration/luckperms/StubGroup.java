...
/**
 * Handgeschriebenes {@link Group}-Test-Double (siehe {@link StubLuckPerms} fuer den Grund).
 * Wird von {@link LuckPermsPermissionBridge} nur auf {@code null}/nicht-{@code null} geprueft
 * (existiert die Gruppe?) - keine Methode davon wird tatsaechlich aufgerufen.
 */
