...
/** Persistente Anti-Dupe-Sperre fuer bereits eingeloeste Crate-Seriennummern. */
    ...
    public CompletableFuture<Boolean> redeem(UUID serial) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try (FileWriter writer = new FileWriter(file, true)) {
                ...
                logger.log(Level.SEVERE, "Crate-Seriennummer konnte nicht gespeichert werden: " + serial, ex);
                return false;
            }
        }, executor);
    }
