...
/** Persistente Phase-6-Mastery fuer Hot-Zone-Kills und King-Altar-Captures. */
public final class MapMasteryService {
    ...
    public void addHotZoneKill(UUID uuid) {
        add(uuid, "hot-zone-kills", 1);
    }

    public void addKingCapture(UUID uuid) {
        add(uuid, "king-captures", 1);
    }

    public int getHotZoneKills(UUID uuid) {
        return data.getInt(path(uuid, "hot-zone-kills"), 0);
    }

    public int getKingCaptures(UUID uuid) {
        return data.getInt(path(uuid, "king-captures"), 0);
    }
